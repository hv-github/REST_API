...
handlers._users.post = function(data,callback){
  //Check that all required fields are filled Route
        ...
        if(hashedPassword == userData.hashedPassword){
          ...
          _data.create('tokens', tokenId, tokenObject, function(err){
            if(!err){
              ...
              callback(500, {'Error' : 'Could not create the new token for some reasons'});
            }
          });
              ...
              if(!err){
                ...
                _data.read('users', checkData.userPhone, function(err, userData){
                  if(!err && userData){
                    ...
                    callback(500, {'Error' : 'Could not find the user who create the check, so could not remove the check from the lsit of check of the user object'});
                  }
                });
              }else{
